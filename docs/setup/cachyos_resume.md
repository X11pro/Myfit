...
- La base visual reusable ya existe en `mobile/fitness_app/lib/shared/ui/`; al retomar no volver a hardcodear estilos sueltos si ya existe componente reutilizable.
